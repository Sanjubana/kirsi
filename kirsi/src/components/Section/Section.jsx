    ...
    <div className ='section'>
      ...
      <div className='section-container'>
        <div className='service-home-card'>
            ...
            <span className='service-home-info'>Services available near you <br /> within 30 km </span>
        </div>
         <div className='service-home-card'>
            <div className='service-home-icon'>🌾</div>
            <h2>Crop Advisory</h2>
            ...
            <span className='service-home-info'>Services available near you <br /> within 50 km </span>
        </div>
         <div className='service-home-card'>
            <div className='service-home-icon'>🐄</div>
            <h2>Animal Care</h2>
